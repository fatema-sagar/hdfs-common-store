...
public class DailyPartitionerTest extends AzureBlobStorageSourceConnectorTestBase {
  ...
  protected Map<String, String> createProps() {
    ...
    props.put(AzureBlobStorageSourceConnectorConfig.PARTITIONER_CLASS_CONFIG, DailyPartitioner.class.getCanonicalName());
    return props;
  }

  /**
   * This method will return the single topic folder present under the root folder.
   * e.g for the storage topics/abs-topic/year=2015/month=12/day=01/abs-topic+0+0000000000.avro
  ...
  public void getSinglePartitionUnderGivenPath() throws IOException {
    ...
    testBlob1.name("topics/abs-topic/year=2015/month=12/day=01/abs-topic+0+0000000000.avro");
   ...
   * e.g for the storage topics/abs-topic/year=2015/month=12/day=01/abs-topic+0+0000000000.avro,
   * topics/abs-other-topic/year=2015/month=12/day=01/abs-other-topic+0+0000000000.avro
  ...
  public void getTwoPartitionsUnderGivenPath() throws IOException {
    ...
    testBlob2.name("topics/abs-other-topic/year=2015/month=12/day=01/abs-other-topic+0+0000000000.avro");
  ...
  public void getFirstFile() throws IOException {
    ...
    testFileBlob.name("topics/abs-topic/year=2015/month=12/day=01/abs-topic+0+0000000000.avro");
    ...
    assertThat(
        firstObject,
        is("topics/abs-topic/year=2015/month=12/day=01/abs-topic+0+0000000000.avro")
    );
  }
}