...
public class DailyPartitionerTest extends GcsTestUtils {
  ...
  public void before() throws IOException {
    ...
    this.settings.put("partitioner.class", DAILY_PARTITIONER);

    this.config = new GcsSourceConnectorConfig(settings);
    this.gcsStorageObject = uploadAvroDataToMockGcsBucket( "year=2015/month=12/day=01",
        "1");
  ...
  public void testPartitionerNextObject() throws IOException {
    ...
    assertThat(firstObject,
        is("topics/gcs_topic/year=2015/month=12/day=01/gcs_topic+0+0000000001.avro"));
  }
