...
This project provides connectors for Kafka Connect to read and write data to HDFS Source Connector.

# Documentation

Documentation on the connector is hosted on Confluent's
[docs site](https://docs.confluent.io/current/connect/kafka-connect-hdfs/).

Source code is located in Confluent's
[docs repo](https://github.com/confluentinc/docs/tree/master/connect/kafka-connect-hdfs). If changes
...
and HDFS Source Connector:

|                          | AK 1.0             | AK 1.1        | AK 2.0        |
| ------------------------ | ------------------ | ------------- | ------------- |
| **HDFS Source Connector v1.2.3** | NOT COMPATIBLE (1) | OK            | OK            |
