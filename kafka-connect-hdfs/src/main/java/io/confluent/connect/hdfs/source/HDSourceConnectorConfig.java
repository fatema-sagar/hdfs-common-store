...
public class HDSourceConnectorConfig extends CloudStorageSourceConnectorCommonConfig {
  ...
  private static final String HDF_POLL_INTERVAL_MS_DOC = "Frequency in milliseconds to poll for new or removed folders. This may result in updated "
  ...
  public static final String HDF_POLL_INTERVAL_MS_DISPLAY = "Metadata Change Monitoring Interval (ms)";
  ...
  private static final String HDF_RETRY_BACKOFF_DOC = "How long to wait in milliseconds before attempting the first retry "
...
//  protected HDSourceConnectorConfig(ConfigDef configDef, Map<String, String> props) { super(configDef, props); }

  @Override
  protected Long getPollInterval() { return getLong(HDF_POLL_INTERVAL_MS_CONFIG); }
