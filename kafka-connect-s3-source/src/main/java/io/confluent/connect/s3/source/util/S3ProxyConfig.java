...
package io.confluent.connect.s3.source.util;
...
import static io.confluent.connect.s3.source.S3SourceConnectorConfig.S3_PROXY_PASS_CONFIG;
import static io.confluent.connect.s3.source.S3SourceConnectorConfig.S3_PROXY_URL_CONFIG;
import static io.confluent.connect.s3.source.S3SourceConnectorConfig.S3_PROXY_USER_CONFIG;
...
public class S3ProxyConfig {
  ...
  public S3ProxyConfig(S3SourceConnectorConfig config) {
    try {
